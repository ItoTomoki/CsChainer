...
forward(smallsentencelist[0], smallsentencelist[0], model, training = True)
...
for i in range(0,100):
	print i
	train(smallsentencelist,smallsentencelist,model)
	hyp_sentence = forward(smallsentencelist[0],smallsentencelist[0],model, training = False)
	text = ""
	for w in smallsentencelist[0]:
		text = text + w
	print "=====問題======"
	print text
	print "=====予測======"
